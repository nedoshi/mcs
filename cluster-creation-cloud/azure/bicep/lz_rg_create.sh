...
# az keyvault create --location $LOCATION --name $KEYVAULT_NAME --resource-group $SERVICES_RG
az keyvault create --location $LOCATION --hsm-name $KEYVAULT_NAME --resource-group $SERVICES_RG --administrators $AAD_APP_CLIENT_ID --retention-days 7
