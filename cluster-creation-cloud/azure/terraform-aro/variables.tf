...
variable "tags" {
  ...
  description = "Azure resource tags. Merged with cost-center 468 and cloud-cost-notifier lifecycle tags expires-at (+2d) and delete-after (+3d) from cluster creation."
}
