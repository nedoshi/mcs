> **Pattern 2** — Standalone stack. See [`../README.md`](../README.md). Not interchangeable with [`../tf-rosa/`](../tf-rosa/).
...
```bash
cd cluster-creation/aws/cluster-zero-egress
```
...
You can also use the Makefile: `make init`, `make plan`, `make apply`. Run `make help` for all targets.
