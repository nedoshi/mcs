...
variable "token" {
  type        = string
  description = "OCM token used to authenticate against the OpenShift Cluster Manager API. See https://console.redhat.com/openshift/token/rosa/show to access your token. Can also be set via RHCS_TOKEN environment variable."
  default     = null
  sensitive   = true
}
